...
class GaussianNaiveBayes:
    def fit(self, X, y):
        ...
        self.priors = {cls: len(X[y == cls]) / len(y)
...
def run_naive_bayes(save_path="models/naive_bayes"):
